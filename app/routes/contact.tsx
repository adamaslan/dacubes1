    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 grid place-items-center p-4 animate-gradient"
        ...
        <div className="max-w-3xl w-full space-y-8">
          ...
          {/* Links Container - Updated with responsive grid */}
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6 max-w-2xl mx-auto">
            <a
              ...
              className="p-4 rounded-xl bg-blue-600/90 hover:bg-blue-700 transition-all duration-300 
                       flex items-center justify-center space-x-2 group animate-float-spin col-span-1"
            >
              <svg className="w-full h-auto text-white max-w-[20%] md:max-w-[10%]" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="p-4 rounded-xl bg-gray-800/90 hover:bg-gray-900 transition-all duration-300 
                       flex items-center justify-center space-x-2 group animate-float-spin col-span-1"
            >
              <svg className="w-full h-auto text-white max-w-[20%] md:max-w-[10%]" fill="currentColor" viewBox="0 0 24 24">
