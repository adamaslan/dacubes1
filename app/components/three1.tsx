...
const DaCubes: React.FC = () => {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < 5; i++) {
            const size = Math.random() * 1 + 0.5; // Cube size between 0.5 and 1.5
            ...
            if (context) {
                ...
                context.fillText(`Cube ${i + 1}`, canvas.width / 2, canvas.height / 2);
            ...
            // Make cube clickable
            cube.userData = { url: `https://example.com/page${i + 1}` };
