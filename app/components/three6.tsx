...
const DaCubes4: React.FC<DaCubes4Props> = () => {
    ...
    useEffect(() => {
        ...
        const geometries = [
            new THREE.DodecahedronGeometry(2),        // 12-sided
            new THREE.IcosahedronGeometry(2),         // 20-sided
            new THREE.OctahedronGeometry(2),          // 8-sided
            new THREE.TetrahedronGeometry(2),         // 4-sided
            new THREE.TorusKnotGeometry(1.5, 0.5, 64, 8)  // Complex knot
        ];

        const cubes: { mesh: THREE.Mesh; velocity: THREE.Vector3; rotationSpeed: THREE.Vector3 }[] = [];
        ...
        for (let i = 0; i < labels.length; i++) {
            ...
            cubes.push({
                ...
                velocity: new THREE.Vector3(
                    (Math.random() - 0.5) * 0.15, // Increased velocity
